...
/** Path from src/assets/icons/Bolt.svg – inlined to avoid SVG import as URL in Module Federation. */
const BOLT_PATH =
...
/** Bolt icon – uses currentColor. Wrapper sets color from theme. Path matches Bolt.svg. */
